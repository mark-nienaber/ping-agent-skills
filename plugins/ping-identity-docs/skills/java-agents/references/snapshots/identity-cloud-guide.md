---
title: About Java Agents and PingOne Advanced Identity Cloud
description: How PingAM Java Agents integrate with PingOne Advanced Identity Cloud to enforce resource-based policies across web applications and APIs.
...
![Java Agents enforce policies from Advanced Identity Cloud.](_images/java-agent-cloud.svg)

For information, refer to the [Advanced Identity Cloud documentation](https://docs.pingidentity.com/pingoneaic/latest/home.html).

---

---
title: Enforce policy decisions from Advanced Identity Cloud
description: Walk through setting up PingOne Advanced Identity Cloud as a policy decision point for requests processed by PingAM Java Agent.
component: java-agents
version: 2026
...
description: Introduction to the PingOne Advanced Identity Cloud guide for customers using PingAM Java Agents in an agent-based integration model.
component: java-agents
version: 2026
...
description: "Prepare PingOne Advanced Identity Cloud for PingAM Java Agent installation: add a test user, create a policy set, and set up an agent profile."
component: java-agents
version: 2026
