...
The following bindings are available to [access token modification](../am-oauth2/plugins-access-token-modifier.html) scripts.
...
| [`identity`](#atmapi-profile)                     | Represents an identity that Advanced Identity Cloud can access.                                                                                            | An [AMIdentity](../_attachments/apidocs/com/sun/identity/idm/AMIdentity.html) object.        | A wrapper object for a scripted identity.                                                                                                                          |
