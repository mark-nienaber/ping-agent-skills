---
title: REST API
description: Learn about PingAM REST APIs, including versioning, endpoints, and how to access the API reference
component: pingam
version: 8.1
page_id: pingam:am-rest:preface
canonical_url: https://docs.pingidentity.com/pingam/8.1/am-rest/preface.html
...
#### [Get started](rest-api-versioning.html)

Learn about the common REST API and how AM supports it.

[icon: compass, set=fad, size=3x]

#### [API Explorer](about-api-explorer.html)

Access the online AM REST API reference through the AM admin UI.

[icon: th-list, set=fad, size=3x]

#### [REST endpoints](rest-endpoints.html)
...
---
title: REST API auditing
description: "Configure PingAM's REST-based audit logging service to track information about all REST API calls"
component: pingam
version: 8.1
page_id: pingam:am-rest:rest-logging
canonical_url: https://docs.pingidentity.com/pingam/8.1/am-rest/rest-logging.html
llms_txt: https://docs.pingidentity.com/pingam/llms.txt
docs_for_agents: https://developer.pingidentity.com/build-with-ai/docs-for-agents.md
keywords: ["REST API"]
page_aliases: ["REST-guide:rest-logging.adoc"]
---

# REST API auditing

AM's common REST-based audit logging service logs information about all REST API calls to the `access` topic.

Learn more in [Audit log topics](../monitoring/audit-logging.html#audit-log-topics).

---

---
title: REST API endpoints
description: REST API endpoints for OpenID Connect, OAuth 2.0, and authentication
component: pingam
version: 8.1
...
description: Understand REST API versioning in PingAM, including resource and protocol versions, how to specify versions in requests, and configure default versioning behavior
component: pingam
version: 8.1
...
---
title: REST in AM
description: Understand REST architectural principles and use Common REST APIs in PingAM to create, read, update, delete, patch, and query resources with HTTP-based verbs
component: pingam
version: 8.1
page_id: pingam:am-rest:rest-intro
canonical_url: https://docs.pingidentity.com/pingam/8.1/am-rest/rest-intro.html
llms_txt: https://docs.pingidentity.com/pingam/llms.txt
docs_for_agents: https://developer.pingidentity.com/build-with-ai/docs-for-agents.md
keywords: ["REST API", "OpenID Connect (OIDC)", "OAuth 2.0", "JSON"]
page_aliases: ["REST-guide:rest-intro.adoc"]
section_ids:
  sec-about-crest: Common REST
...
[REST](https://en.wikipedia.org/wiki/REST) is an architectural style that sets certain constraints for designing and building large-scale distributed hypermedia systems.
...
The common REST API applies RESTful principles to define common verbs for HTTP-based APIs. Most native AM REST APIs use the [common REST verbs](#about-crest-verbs). In contrast, OAuth 2.0, OpenID Connect 1.0 and UMA APIs follow their respective standards.

Learn more about using the REST API in AM in [Configure identities and realms over REST](../setup/sec-rest-realm-rest.html).

|   |                                                                                                                                                         |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   | The common REST interface stability is classified as [evolving](https://docs.pingidentity.com/pingam/release-notes/stability.html#interface-stability). |

## Common REST

Common REST is a common REST API framework. It provides Ping Advanced Identity Software software common ways to access web resources and collections of resources. Adapt the examples in this section to your resources and deployment.

|   |                                                                                                                                                                                           |
| - | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   | This page describes the full Common REST framework. AM doesn't implement all Common REST behaviors exactly as described.Find more details in specific examples and reference information. |
...
* Create
  ...
  Learn more in [Create](#about-crest-create).
...
* Read
  ...
  Learn more in [Read](#about-crest-read).
...
* Update
  ...
  Learn more in [Update](#about-crest-update).
...
* Delete
  ...
  Learn more in [Delete](#about-crest-delete).
...
* Patch
  ...
  Learn more in [Patch](#about-crest-patch).
...
* Action
  ...
  Learn more in [Action](#about-crest-action).
...
* Query
  ...
  Learn more in [Query](#about-crest-query).
...
The *action* verb is the main vehicle for extensions. For example, to create a new user with HTTP POST rather than HTTP PUT, you might use `/users?_action=create`. AM defines additional actions. For example, `/rest-sts/username-transformer?_action=cancel`.
...
Common REST APIs use the `X-ForgeRock-TransactionId` header to track related requests through Ping Advanced Identity Software.
...
|   |                                                                                                                                                                                                                                          |
| - | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   | Consider limiting access to API descriptors in production environments in order to avoid unnecessary traffic.To provide documentation in production environments, see [Publish OpenAPI documentation](#use-openapi-descriptors) instead. |
...
description: Specify realms in PingAM REST API calls using DNS aliases or path parameters
component: pingam
version: 8.1
