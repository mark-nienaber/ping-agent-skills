...
description: Configure the Microsoft Defender for Endpoint connector in PingOne DaVinci to integrate endpoint detection, device trust, and security alerts
