...
description: Configure the Secret Double Octopus connector to enable passwordless push authentication in PingOne DaVinci flows
...
Before configuring the connector in PingOne DaVinci, create a REST service in the Secret Double Octopus Management Console with the following settings:
...
* From the **Sign-On** tab, copy the **API Token**, **X.509 Certificate**, and **REST Endpoint URL**. These values are needed to configure the connector in PingOne DaVinci.
