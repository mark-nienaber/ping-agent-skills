...
description: Configure the String connector to transform text in PingOne DaVinci flows by converting case, concatenating strings, changing data types, and more
