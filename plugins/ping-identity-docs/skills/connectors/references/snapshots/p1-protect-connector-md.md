...
section_ids:
  ...
  create-risk-evaluation: Create Risk Evaluation
  steps: Steps
  update-risk-evaluation: Update Risk Evaluation
  steps-2: Steps
  capabilities: Capabilities
  createRiskEvaluation: Create Risk Evaluation
  updateRiskEvaluation: Update Risk Evaluation
  sendRiskEvaluationFeedback: Send Risk Evaluation Feedback
  troubleshooting: Troubleshooting
---

# PingOne Protect Connector

This connector lets you use PingOne Protect in a PingOne DaVinci flow to improve the user experience, reduce multi-factor authentication (MFA) *(tooltip: \<div class="paragraph">
...
Learn more in the [PingOne Protect documentation](https://docs.pingidentity.com/pingone/threat_protection_using_pingone_protect/p1_protect_introduction.html).
...
* A worker application configured in your PingOne environment. Learn more in [Choosing a PingOne worker app](#choosing-a-pingone-worker-app).

* A PingOne Protect risk policy. You can use the default risk policy or create a custom risk policy. Learn more in [Risk policies](https://docs.pingidentity.com/pingone/threat_protection_using_pingone_protect/p1_protect_risk_policies.html).
...
The **Client ID** of the worker application you identified in [Choosing a PingOne worker app](#choosing-a-pingone-worker-app).

##### Client Secret

The **Client Secret** from the **Configuration** tab of the PingOne worker application you identified in [Choosing a PingOne worker app](#choosing-a-pingone-worker-app).

## Using the connector in a flow

Use the PingOne Protect connector to add risk evaluations to different types of flows, such as sign-on with MFA or passwordless sign-on. You can use the PingOne Protect connector in template flows available in the [Ping Identity Marketplace](https://marketplace.pingone.com/browse?products=davinci\&contentType=davinciConnectors), such as:

* [PingOne Adaptive Authentication with MFA via OTP or FIDO](https://marketplace.pingone.com/item/pingone-adaptive-authentication-with-protect-and-mfa-via-otp-or-fido)

* [PingOne for Customers Passwordless](https://marketplace.pingone.com/item/ciam-passwordless-flow-pack)

* [Authentication Journey with Threat Detection](http://marketplace.pingone.com/item/authentication-journey-with-threat-detection)

Learn more about risk evaluations and how the response result affects the user flow in [Reviewing risk evaluations](https://docs.pingidentity.com/pingone/threat_protection_using_pingone_protect/p1_protect_reviewing_risk_evaluations.html).
...
Evaluate risk for a specific transaction based on predictors, such user location anomaly, IP reputation, and bot detection. Learn more in [Predictors](https://docs.pingidentity.com/pingone/threat_protection_using_pingone_protect/p1_protect_risk_predictors.html).
...
4. To improve risk analysis, include the data for additional risk-related variables provided by the Signals (Protect) SDK.
   ...
   * Include a variable in your flow that represents the data obtained.
   ...
   With this approach, the information from the Signals Web SDK is obtained automatically. However, for the Signals Mobile SDK, you must implement the steps in the [SDK documentation](https://apidocs.pingidentity.com/pingone/native-sdks/v1/api/#pingone-protect-native-sdks) manually.
...
2. Update the risk evaluation completion status for `SUCCESS` and `FAILED` events.
   ...
   Learn more in [Updating completion status for risk evaluations](https://docs.pingidentity.com/pingone/threat_protection_using_pingone_protect/p1_protect_updating_completion_status_risk_evaluations.html).
...
Submit feedback to help refine risk classification or clear a user's risk status.
...
> * Output Schema
>
> - Risk Evaluation ID textField required
>
>   The ID of the risk evaluation you are providing feedback on.
>
> - Feedback Category dropDown required
>
>   The type of feedback to submit for the risk evaluation.
>
>   * FALSE\_HIGH\_RISK
>
>   * FRIENDLY\_BOT
...
> - Reason dropDown
>
>   Reason for FRIENDLY\_BOT
>
>   * KNOWN\_CRAWLER
>
>   * KNOWN\_AGGREGATOR
>
>   * INTERNAL\_AUTOMATION
>
>   * OTHER
>
> - Reason dropDown
>
>   Reason for NEW\_ACCOUNT\_FRAUD
>
>   * SUSPICIOUS\_EMAIL\_ADDRESS
>
>   * USERNAME\_GUESSING
>
>   * OTHER
...
> - Reason dropDown
>
>   Reason for COMPROMISED\_ACCOUNT
>
>   * USER\_CLAIMS\_IT\_IS\_NOT\_THEM
>
>   * UNSUCCESSFUL\_MFA
>
>   * OTHER
...
>       Client ID
>
>     * riskEvaluationId string required
>
>       Risk Evaluation ID
>
>     * feedbackCategory string required minLength: 0 maxLength: 100
>
>       Feedback Category
>
>     * reason string minLength: 0 maxLength: 100
>
