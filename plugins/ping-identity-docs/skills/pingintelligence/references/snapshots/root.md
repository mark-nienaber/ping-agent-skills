...
---
title: PingIntelligence for APIs
description: PingIntelligence for APIs uses artificial intelligence (AI) to secure APIs in your environment by identifying and automatically blocking cyberattacks on APIs, exposing active APIs, and providing detailed reporting on all API activity.
component: pingintelligence
version: 5.2
page_id: pingintelligence::pingintelligence
canonical_url: https://docs.pingidentity.com/pingintelligence/5.2/pingintelligence.html
revdate: April 3, 2024
page_aliases: ["_@pingintelligence::index.adoc"]
section_ids:
  release-notes: Release Notes
  get-started-with-pingintelligence: Get Started with PingIntelligence
  use-pingintelligence: Use PingIntelligence
  troubleshoot-pingintelligence: Troubleshoot PingIntelligence
...
* [PingIntelligence 5.2 (September 2023)](release_notes/pingintelligence_release_notes_52.html)

* [PingIntelligence 5.1 (December 2021)](release_notes/pingintelligence_release_notes_51.html)

* [PingIntelligence 5.0.1 (August 2021)](release_notes/pingintelligence_release_notes_501.html)

* [Previous Releases](release_notes/pingintelligence_previous_releases.html)

## Get Started with PingIntelligence

* [Introduction to PingIntelligence for APIs](pingintelligence_introduction.html)

* [PingIntelligence Docker evaluation deployment](installing_pingintelligence_for_apis/pingintelligence_docker_evaluation.html)

* [PingIntelligence Docker toolkit](installing_pingintelligence_for_apis/pingintelligence_docker_toolkit.html)

* [Automated deployment](installing_pingintelligence_for_apis/pingintelligence_automated_deployment.html)

* [Manual deployment](installing_pingintelligence_for_apis/pingintelligence_manual_deployment.html)
...
* [Use Case: Converting SSL certificates to ASE compatible format](pingintelligence_reference_guide/pingintelligence_converting_ssl_certificates.html)

* [PingIntelligence Integrations](pingintelligence_integrations/pingintelligence_integrations.html)

## Troubleshoot PingIntelligence

* [PingIntelligence Health Check Guide](installing_pingintelligence_for_apis/pingintelligence_health_check.html)

## Learn More

* [Community](https://support.pingidentity.com/s/topic/0TO1W0000001Qf1WAE/pingintelligence)
